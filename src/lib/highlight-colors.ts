 ...
 */
export const HIGHLIGHT_COLORS: Record<HighlightCategory | "default", HighlightColorConfig> = {
    "extracted-text": {
 ...
 */
export const getHighlightColors = (category?: HighlightCategory): HighlightColorConfig => {
