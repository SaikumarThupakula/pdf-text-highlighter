...
export interface AreaHighlightProps {
    ...
    /**
     * Callback triggered when clicking the highlight.
     */
    onClick?(): void;
}
/**
 ...
 * @category Component
 */
export declare const AreaHighlight: ({ highlight, onChange, isScrolledTo, bounds, onContextMenu, onEditStart, style, showCategoryColor, onClick, }: AreaHighlightProps) => React.JSX.Element;
