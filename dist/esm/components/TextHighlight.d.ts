 ...
 * @category Component
 */
export declare const TextHighlight: ({ highlight, onClick, onMouseOver, onMouseOut, isScrolledTo, onContextMenu, style, showCategoryColor, }: TextHighlightProps) => React.JSX.Element;
